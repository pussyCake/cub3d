...
/*   Updated: 2021/04/24 20:34:41 by pantigon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_raylen(t_cub *cub)
{
	...
	cub->rc.wall_h = (cub->win_w / 1.6 / cub->rc.wall_dist);
...
void	ft_create_world(t_cub *cub)
{
	...
	while (x < cub->win_w)
	{
		...
		ft_raylen(cub);
		if (cub->rc.text.id == 0)
			ft_texture(cub, cub->text_w, x);
		else if (cub->rc.text.id == 1)
			ft_texture(cub, cub->text_n, x);
		else if (cub->rc.text.id == 2)
			ft_texture(cub, cub->text_e, x);
		else if (cub->rc.text.id == 3)
			ft_texture(cub, cub->text_s, x);
